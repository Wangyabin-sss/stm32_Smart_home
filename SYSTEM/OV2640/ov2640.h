...
#define  OV2640_VSYNC 	PEin(0)		//VSYNC帧信号 
#define  OV2640_HREF  	PEin(3)		//HREF行信号 
#define  OV2640_PCLK  	PEin(4)		//PCLK像素信号 	
#define  OV2640_DATA   	(GPIOB->IDR&0xFF00)>>8	//数据输入端口 32位寄存器，0~15位对应gpio0~15,后16位保留，PB8~15脚接8位并口
