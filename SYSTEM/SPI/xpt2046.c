...
void xpt2046_init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin=GPIO_Pin_6;           //T_CS
	GPIO_InitStructure.GPIO_Mode=GPIO_Mode_OUT;        //输出模式
	GPIO_InitStructure.GPIO_Speed=GPIO_Speed_100MHz;    //100MHz
	GPIO_InitStructure.GPIO_OType=GPIO_OType_PP;	   //推挽
	GPIO_InitStructure.GPIO_PuPd=GPIO_PuPd_NOPULL;		 
	...
	GPIO_InitStructure.GPIO_Pin=GPIO_Pin_5;           //T_CLK
	GPIO_InitStructure.GPIO_Mode=GPIO_Mode_OUT;        //输出模式
	GPIO_InitStructure.GPIO_Speed=GPIO_Speed_100MHz;    //100MHz
	GPIO_InitStructure.GPIO_OType=GPIO_OType_PP;	   //推挽
	GPIO_InitStructure.GPIO_PuPd=GPIO_PuPd_NOPULL;		 
	...
	GPIO_InitStructure.GPIO_Pin=GPIO_Pin_6;           //T_MISO
...
void touch_getxy(int16_t *posx,int16_t *posy)
{
	...
	*posx=(int16_t)(0.0851*xall-13.82);
	*posy=(int16_t)(0.1296*yall-25.352);
}
